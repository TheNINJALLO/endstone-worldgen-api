...
[![Version](https://img.shields.io/badge/version-v0.4.5--beta.9-blue.svg?style=for-the-badge)](https://github.com/TheNINJALLO/endstone-worldgen-api/releases/tag/v0.4.5-beta.9)
...
[![Platform](https://img.shields.io/badge/platform-Windows%20%7C%20Linux-orange.svg?style=for-the-badge)](#-direct-release-downloads-v045-beta9)
...
## 📦 Direct Release Downloads (`v0.4.5-beta.9`)

| Platform | BDS Version | Artifact Filename | Direct Download |
| :--- | :--- | :--- | :--- |
| **Windows x64** | `1.26.32` | `endstone-worldgen-api-v0.4.5-beta.9-bds-1.26.32-windows-x64.dll` | [Download](https://github.com/TheNINJALLO/endstone-worldgen-api/releases/download/v0.4.5-beta.9/endstone-worldgen-api-v0.4.5-beta.9-bds-1.26.32-windows-x64.dll) |
| **Windows x64** | `1.26.33` | `endstone-worldgen-api-v0.4.5-beta.9-bds-1.26.33-windows-x64.dll` | [Download](https://github.com/TheNINJALLO/endstone-worldgen-api/releases/download/v0.4.5-beta.9/endstone-worldgen-api-v0.4.5-beta.9-bds-1.26.33-windows-x64.dll) |
| **Linux x64** | `1.26.32` | `endstone-worldgen-api-v0.4.5-beta.9-bds-1.26.32-linux-x64.so` | [Download](https://github.com/TheNINJALLO/endstone-worldgen-api/releases/download/v0.4.5-beta.9/endstone-worldgen-api-v0.4.5-beta.9-bds-1.26.32-linux-x64.so) |
| **Linux x64** | `1.26.33` | `endstone-worldgen-api-v0.4.5-beta.9-bds-1.26.33-linux-x64.so` | [Download](https://github.com/TheNINJALLO/endstone-worldgen-api/releases/download/v0.4.5-beta.9/endstone-worldgen-api-v0.4.5-beta.9-bds-1.26.33-linux-x64.so) |
| **Python Wheel** | `Universal` | `endstone_worldgen_studio-0.4.5b9-py3-none-any.whl` | [Download](https://github.com/TheNINJALLO/endstone-worldgen-api/releases/download/v0.4.5-beta.9/endstone_worldgen_studio-0.4.5b9-py3-none-any.whl) |
