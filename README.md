...
[![Version](https://img.shields.io/badge/version-v0.4.5--beta.32-blue.svg?style=for-the-badge)](https://github.com/TheNINJALLO/endstone-worldgen-api/releases/tag/v0.4.5-beta.32)
...
[![Platform](https://img.shields.io/badge/platform-Windows%20%7C%20Linux-orange.svg?style=for-the-badge)](#-direct-release-downloads-v045-beta32)
...
## 📦 Direct Release Downloads (`v0.4.5-beta.32`)
...
| :--- | :--- | :--- | :--- |
| **Windows x64 ZIP (recommended)** | `1.26.33` | `endstone-worldgen-api-v0.4.5-beta.32-bds-1.26.33-windows-x64.zip` | [Download](https://github.com/TheNINJALLO/endstone-worldgen-api/releases/download/v0.4.5-beta.32/endstone-worldgen-api-v0.4.5-beta.32-bds-1.26.33-windows-x64.zip) |
| **Linux x64 ZIP (recommended)** | `1.26.33` | `endstone-worldgen-api-v0.4.5-beta.32-bds-1.26.33-linux-x64.zip` | [Download](https://github.com/TheNINJALLO/endstone-worldgen-api/releases/download/v0.4.5-beta.32/endstone-worldgen-api-v0.4.5-beta.32-bds-1.26.33-linux-x64.zip) |
| **Windows x64 raw plugin** | `1.26.33` | `endstone-worldgen-api-v0.4.5-beta.32-bds-1.26.33-windows-x64.dll` | [Download](https://github.com/TheNINJALLO/endstone-worldgen-api/releases/download/v0.4.5-beta.32/endstone-worldgen-api-v0.4.5-beta.32-bds-1.26.33-windows-x64.dll) |
| **Linux x64 raw plugin** | `1.26.33` | `endstone-worldgen-api-v0.4.5-beta.32-bds-1.26.33-linux-x64.so` | [Download](https://github.com/TheNINJALLO/endstone-worldgen-api/releases/download/v0.4.5-beta.32/endstone-worldgen-api-v0.4.5-beta.32-bds-1.26.33-linux-x64.so) |
| **Windows `/wg` wheel** | `CPython 3.14` | `endstone_worldgen_studio-0.4.5b32-cp314-cp314-win_amd64.whl` | [Download](https://github.com/TheNINJALLO/endstone-worldgen-api/releases/download/v0.4.5-beta.32/endstone_worldgen_studio-0.4.5b32-cp314-cp314-win_amd64.whl) |
| **Linux `/wg` wheel** | `CPython 3.14` | `endstone_worldgen_studio-0.4.5b32-cp314-cp314-linux_x86_64.whl` | [Download](https://github.com/TheNINJALLO/endstone-worldgen-api/releases/download/v0.4.5-beta.32/endstone_worldgen_studio-0.4.5b32-cp314-cp314-linux_x86_64.whl) |
...
Stop the server and remove older WorldGen Studio wheels before copying beta.32; leaving multiple versions in `plugins/` can make Endstone install them in an undefined order.
...
cp endstone_worldgen_studio-0.4.5b32-cp314-cp314-linux_x86_64.whl /path/to/endstone/plugins/
```
...
server, preserve cells outside their bounded patch, and never edit biomes. Use a
...
ChunkSource interception is inactive or has zero registered populators; status
reports those automatic-pipeline conditions separately. The live surface/floor
