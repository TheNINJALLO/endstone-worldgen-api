...
`conanfile.py` pins the dependency graph for Endstone 0.11.11 and BDS 1.26.51. `scripts/build_exact.py` configures the public Endstone Cloudsmith remote, installs the graph with Conan 2, and passes the generated CMake toolchain into the exact build.
