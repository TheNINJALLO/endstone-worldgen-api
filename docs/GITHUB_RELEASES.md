...
The workflow downloads both verified exact-build artifacts, creates `SHA256SUMS.txt`, and creates a published, non-prerelease GitHub Release. Stable `v0.4.6` is explicitly marked as the repository's Latest release.
